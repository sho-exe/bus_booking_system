                ...
                <%@ page import="model.Trip" %>
                    <%@ page import="dao.TripDAO" %>
                        ...
                        <% String origin=request.getParameter("origin"); String
                            ...
                            return_date=request.getParameter("return_date"); TripDAO tripDAO=new TripDAO(); List<String>
                            originsList = tripDAO.getDistinctOrigins();
                            List<String> destinationsList = tripDAO.getDistinctDestinations();
                                %>
...
<h1><%=session.getAttribute("passengerId")%></h1>-->
                                ...
                                <div class="main-container" style="margin-top: 50px;">
                                    ...
                                    <div style="text-align: center; margin-bottom: 30px;">
                                        <div class="tab-nav" style="margin-top: 20px; display: inline-flex;">
                                            <a href="#" class="tab active"><i class="fa-solid fa-magnifying-glass"></i>
                                                Book
                                                Trip</a>
                                            <a href="customer.jsp" class="tab"><i class="fa-solid fa-ticket"></i> My
                                                Bookings</a>
                                            <a href="profile.jsp" class="tab"><i class="fa-regular fa-user"></i>
                                                Profile</a>
                                        </div>
                                        ...
                                        <div style="margin-top: 25px;">
                                            ...
                                            <p style="color: #6b7280; font-size: 16px; margin: 0;">Find the best routes
                                                and book
                                    ...
                                    <div class="promo-container">
                                        <div class="promo-card senior">
                                            ...
                                            <div class="promo-content">
                                                ...
                                                <p class="promo-desc">Elders (ages 60+) enjoy an automatic 50% discount
                                                    on every
                                                    ticket purchased.</p>
                                            </div>
                                        </div>
                                        <div class="promo-card return">
                                            ...
                                            <div class="promo-content">
                                                ...
                                                <p class="promo-desc">Book a return journey and enjoy a 10% discount on
                                                    your
                                    ...
                                    <div class="search-card">
                                        <h2 class="card-title"
                                            style="margin-bottom: 25px; color: #cc2525; font-size: 18px;"><i
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-wrapper">
                                                        ...
                                                        <div class="custom-dropdown">
                                                            <input type="text" id="originInput" name="origin"
                                                                class="form-control" placeholder="Select or type origin"
                                                                value="<%= (origin!=null) ? origin : "" %>" required
                                                                autocomplete="off" onclick="showDropdown('originList')"
                                                                onkeyup="filterDropdown('originInput', 'originList')">
                                                            <i class="fa-solid fa-chevron-down dropdown-icon"></i>
                                                            <div id="originList" class="custom-dropdown-list">
                                                                <% for(String orig : originsList) { %>
                                                                    <div
                                                                        onclick="selectValue('originInput', '<%= orig %>', 'originList')">
                                                                        <%= orig %>
                                                                    </div>
                                                                    <% } %>
                                                            </div>
                                                    ...
                                                    <div class="input-wrapper">
                                                        ...
                                                        <div class="custom-dropdown">
                                                            <input type="text" id="destinationInput" name="destination"
                                                                ...
                                                                onclick="showDropdown('destinationList')"
                                                                onkeyup="filterDropdown('destinationInput', 'destinationList')">
                                                            <i class="fa-solid fa-chevron-down dropdown-icon"></i>
                                                            <div id="destinationList" class="custom-dropdown-list">
                                                                <% for(String dest : destinationsList) { %>
                                                                    <div
                                                                        onclick="selectValue('destinationInput', '<%= dest %>', 'destinationList')">
                                                                        <%= dest %>
                                                                    </div>
                                                                    <% } %>
                                                            </div>
                                        ...
                                        <form action="SelectSeat.jsp" method="POST" id="tripSelectionForm">
                                            ...
                                            <% }%>
                                                ...
                                                <% if (request.getAttribute("trips") !=null &&
                                                    request.getAttribute("busList") !=null) { List<Trip> trips = (List
                                                    <Trip>) request.getAttribute("trips");
                                                                ...
                                                                <% } else { for (int i=0; i < trips.size(); i++) { Trip
                                                                    ...
                                                                    <% } } } %>
                                                                        ...
                                                                        <%-- ── RETURN TRIPS SECTION
                                                                            ─────────────────────────────── --%>
                                                                            <% if (request.getAttribute("returnTrips")
                                                                                !=null &&
                                                                                request.getAttribute("returnBusList")
                                                                                !=null) { List<Trip> returnTrips = (List
                                                                                <Trip>)
                     ...
                     border-radius:18px; color:#999; font-size:14px;">
                                                                                                ...
                                                                                                <% } else { for (int
                                                                                                    ...
                                                                                                    returnTrips.size();
                                                                                                    i++) { Trip
                                                                                                    rt=returnTrips.get(i);
                                                                                                    Bus
                                                                                                    rb=returnBusList.get(i);
                                                                                                    %>
                                                                                                    <div
                                                                                                        class="trip-card">
                                                                                                        <div
                                ...
                                <script>
                                    ...
                                    function filterDropdown(inputId, listId) {
                                        ...
                                        const divs = document.getElementById(listId).getElementsByTagName('div');
                                        for (let i = 0; i < divs.length; i++) {
                                            if (divs[i].innerText.toLowerCase().indexOf(filter) > -1) {
