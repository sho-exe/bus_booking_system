...
<!--        
        ...
        <div class="main-container">
            ...
            <div class="search-card">
                <h2 class="card-title"><i class="fa-solid fa-magnifying-glass"></i> Search Bus Trips</h2>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <select name="origin" class="form-control" required>
                                    <option value="" disabled <%= (origin == null) ? "selected" : ""%>>Select origin</option>
                                    <option value="Kuala Terengganu" <%= ("Kuala Terengganu".equals(origin)) ? "selected" : ""%>>Kuala Terengganu</option>

                                    <option value="Kuala Lumpur" <%= ("Kuala Lumpur".equals(origin)) ? "selected" : ""%>>Kuala Lumpur</option>
                                    <option value="Penang" <%= ("Penang".equals(origin)) ? "selected" : ""%>>Penang</option>
                                    <option value="Johor Bahru" <%= ("Johor Bahru".equals(origin)) ? "selected" : ""%>>Johor Bahru</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <select name="destination" class="form-control" required>
                                    <option value="" disabled <%= (destination == null) ? "selected" : ""%>>Select destination</option>
                                    <option value="Kuala Lumpur" <%= ("Kuala Lumpur".equals(destination)) ? "selected" : ""%>>Kuala Lumpur</option>
                                    <option value="Penang" <%= ("Penang".equals(destination)) ? "selected" : ""%>>Penang</option>
                                    <option value="Johor Bahru" <%= ("Johor Bahru".equals(destination)) ? "selected" : ""%>>Johor Bahru</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="date" name="trip_date" class="form-control" value="<%= (trip_date != null) ? trip_date : ""%>" required>
                            </div>
                        </div>
