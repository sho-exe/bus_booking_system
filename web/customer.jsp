            ...
            <%@page contentType="text/html" pageEncoding="UTF-8" %>
                ...
                <body>
                    ...
                    <% String role=(String) session.getAttribute("userRole"); String username=(String)
                        session.getAttribute("username"); String userId=(String) session.getAttribute("passengerId");
                        BookingDAO bookingDAO=new BookingDAO(); List<Booking> myBookings = (userId != null)
                            ...
                            <div class="main-container" style="margin-top: 50px;">
                                ...
                                <div style="text-align: center; margin-bottom: 30px;">
                                    <div class="tab-nav tab-nav-top" style="display: inline-flex;">
                                        <a href="Booking.jsp" class="tab"><i class="fa-solid fa-magnifying-glass"></i>
                                            Book Trip</a>
                                ...
                                <div class="results-container">
                                    ...
                                    <% if (myBookings.isEmpty()) { %>
                                        ...
                                        <div class="trip-card no-bookings-card">
                                            ...
                                            <p>You have no bookings yet. <br> <a href="Booking.jsp">Search for a
                                                    trip</a></p>
                                        </div>
