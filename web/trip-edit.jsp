...
<head>
    <meta charset="UTF-8">
    <title>Edit Trip - Sani Express</title>
    ...
    <div class="auth-card">
        <div class="card-header">
            ...
            <div class="card-title">
                <h2>Edit Trip</h2>
                <p>Modify the details of the selected trip</p>
            </div>
        </div>
        ...
        <form action="TripServlet?action=update" method="post">
            ...
            <div class="form-row">
                <div class="form-col">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" name="origin" value="${trip.origin}" class="form-input" placeholder="e.g. Kuala Lumpur" required>
                ...
                <div class="form-col">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" name="destination" value="${trip.destination}" class="form-input" placeholder="e.g. Penang" required>
            ...
            <div class="form-row">
                ...
                <div class="form-col" style="flex: 1;">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="number" step="0.01" min="0" name="price" value="${trip.price}" class="form-input" placeholder="0.00" required>
            ...
            <button type="submit" class="btn-primary">
                <i class="fa-solid fa-check"></i> Update Trip Details
            </button>
        </form>
    </div>
</div>
