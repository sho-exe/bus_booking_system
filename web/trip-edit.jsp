    ...
    <div class="auth-card">
        ...
        <form action="TripServlet?action=update" method="post">
            ...
            <div class="form-group">
                <label>Origin</label>
                <input type="text" name="origin" value="${trip.origin}" class="form-input" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" name="price" value="${trip.price}" class="form-input" required>
            </div>
            
            <button type="submit" class="btn-primary" style="margin-top: 10px;">Update Trip</button>
        </form>
    </div>
</div>
